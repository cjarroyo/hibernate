 ...
 * @author josediaz
 */
@NamedQueries({ @NamedQuery(name = Automovil.LISTAR_DESTACADOS, query = "select a from Automovil a", hints = {
...
public class Automovil implements Serializable {
	...
	@Min(1900)
	@MaxAnoMasActual(message = "El valor maximo del año de fabricacion es {0}")
	private Integer anoFabricacion;

	@Min(1900)
	@MaxAnoMasActual(value = 1, message = "El valor maximo del año del modelo es {0}")
	...
	public String toString() {
		return "Automovil{" + "id=" + id + ", modelo=" + modelo + ", color=" + color + ", fotos=" + fotos
				+ ", anoFabricacion=" + anoFabricacion + ", anoModelo=" + anoModelo + ", precio=" + precio
				+ ", kilometraje=" + kilometraje + ", observaciones=" + observaciones + '}';
	}
